...
//Jiangsheng
//(This is his account name at www.CSDN.net)
// E-Mail  ：slwqw@163.com,sheng_jiang@hotmail.com
...
//  CString Str;
  ...
  BOOL	bIsTerminalServices=FALSE;//Is_Terminal_Services();
  if(bIsTerminalServices){
	//get current session ID
	CWTSWrapper	WTS;
	if (WTS.IsValid())
	{
		DWORD	dwCurSessionID = (DWORD)-1;
