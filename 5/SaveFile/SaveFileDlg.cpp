...
CSaveFileDlg::CSaveFileDlg(CWnd* pParent /*=NULL*/)
...
void CSaveFileDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CSaveFileDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CSaveFileDlg::OnBnClickedSavefile()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	filename.Flags = OFN_CREATEPROMPT | OFN_FILEMUSTEXIST | OFN_PATHMUSTEXIST | OFN_OVERWRITEPROMPT | OFN_HIDEREADONLY;
	...
	MessageBox(filepath, "文件路径为：", MB_OK);
