...
void CCreateProgressDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CCreateProgressDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CCreateProgressDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CCreateProgressDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码

	m_myCtrl.Create(WS_CHILD|WS_VISIBLE|PBS_SMOOTH, CRect(10,10,200,30), this, 1003);

	m_myCtrl.SetRange(0, 100);
	m_myCtrl.SetStep(10);
	//OnOK();
}

void CCreateProgressDlg::OnBnClickedRun()
{
	// TODO: 在此添加控件通知处理程序代码

	m_Step += 10;
	m_myCtrl.SetPos(m_Step);
}
