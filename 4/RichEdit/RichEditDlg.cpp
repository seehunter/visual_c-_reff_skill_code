...
BEGIN_MESSAGE_MAP(CRichEditDlg, CDialog)
	...
	ON_EN_SETFOCUS(IDC_RICHEDIT22, OnEnSetfocusRichedit22)
END_MESSAGE_MAP()
...
void CRichEditDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码

	/*int nFirstVisible = m_RichEdit.GetFirstVisibleLine();
	if (nFirstVisible > 0)
	{
		m_RichEdit.LineScroll(nFirstVisible, 0);
	}
...
void CRichEditDlg::OnEnSetfocusRichedit22()
{
	// TODO: 在此添加控件通知处理程序代码
	/*int nFirstVisible = m_RichEdit.GetFirstVisibleLine();
	if (nFirstVisible > 0)
