...
CLinkFTPDlg::CLinkFTPDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CLinkFTPDlg::IDD, pParent)
{
...
void CLinkFTPDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CLinkFTPDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
void CLinkFTPDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CLinkFTPDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CLinkFTPDlg::OnBnClickedLink()
{
